...
### Added
- **Add fakechat channel plugin** — Add fakechat channel plugin
  [`75e1c5d`](https://github.com/anthropics/claude-plugins-official/commit/75e1c5d437f9663fcefd12bdab74cf838fafe428) · 2026-03-18 · ([#738](https://github.com/anthropics/claude-plugins-official/pull/738))
